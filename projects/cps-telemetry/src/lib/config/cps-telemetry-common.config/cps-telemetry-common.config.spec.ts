import { CPS_DEFAULT_BI_TELEMETRY_CONFIG } from '../cps-bi-telemetry.config/cps-bi-telemetry.config';
import { CPS_DEFAULT_LOG_CONFIG } from '../cps-log.config/cps-log.config';
import { CPS_DEFAULT_SCENARIO_TELEMETRY_CONFIG } from '../cps-scenario-telemetry.config/cps-scenario-telemetry.config';
...
describe('CPS_DEFAULT_TELEMETRY_CONFIG', () => {
  ...
  it("should compose each concern's own default", () => {
    ...
    expect(CPS_DEFAULT_TELEMETRY_CONFIG.bi).toBe(
