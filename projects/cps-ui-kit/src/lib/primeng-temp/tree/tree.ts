 ...
 * Original file: packages/primeng/src/tree/tree.ts
...
import { ChevronDownIcon, ChevronRightIcon, SearchIcon, SpinnerIcon } from '../icons/public_api';
    ...
    template: `
        @if (node) {
            <li
                ...
                [attr.aria-posinset]="$any(index) + 1"
                [attr.aria-level]="$any(level) + 1"
            ...
            >
                ...
                <div
                    ...
                    [style.paddingLeft]="$any(level) * $any(indentation) + 'rem'"
                    ...
                    (dragleave)="$any(onNodeDragLeave)($event)"
                ...
                >
                    ...
                    <p-checkbox
                        ...
                        *ngIf="tree.selectionMode == 'checkbox'"
                        ...
                        [variant]="$any(tree)?.config.inputStyle() === 'filled' || $any(tree)?.config.inputVariant() === 'filled' ? 'filled' : 'outlined'"
            ...
            >
                <ng-template #content let-items let-scrollerOptions="options">
                    ...
                    >
                        <p-treeNode
                            #treeNode
                            *ngFor="let rowNode of items; let firstChild = first; let lastChild = last; let index = index; trackBy: $any(trackBy)"
                            [level]="rowNode.level"
                            [rowNode]="rowNode"
                            [node]="rowNode.node"
