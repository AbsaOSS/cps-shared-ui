 ...
 * Original file: packages/primeng/src/togglebutton/togglebutton.ts
...
import { ToggleButtonChangeEvent, ToggleButtonContentTemplateContext, ToggleButtonIconTemplateContext, ToggleButtonPassThrough } from '../types/togglebutton/public_api';
