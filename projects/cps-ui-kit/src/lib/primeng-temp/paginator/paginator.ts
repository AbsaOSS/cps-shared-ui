 ...
 * Original file: packages/primeng/src/paginator/paginator.ts
...
import { Aria, PrimeTemplate, SelectItem, SharedModule } from '../api/public_api';
import { BaseComponent, PARENT_INSTANCE } from '../basecomponent/public_api';
import { Bind } from '../bind/public_api';
import { Select, SelectChangeEvent } from '../select/public_api';
import { AngleDoubleLeftIcon, AngleDoubleRightIcon, AngleLeftIcon, AngleRightIcon } from '../icons/public_api';
import { InputNumber } from '../inputnumber/public_api';
import { Ripple } from '../ripple/public_api';
import { Nullable } from '../ts-helpers/public_api';
import { PaginatorDropdownItemTemplateContext, PaginatorPassThrough, PaginatorState, PaginatorTemplateContext } from '../types/paginator/public_api';
    ...
    template: `
        ...
        <p-select
            ...
            *ngIf="rowsPerPageOptions"
            ...
            [disabled]="empty()"
            (onChange)="onRppChange($any($event))"
            [appendTo]="dropdownAppendTo || $appendTo()"
            [scrollHeight]="dropdownScrollHeight"
