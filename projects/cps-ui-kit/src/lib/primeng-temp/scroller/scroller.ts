 ...
 * Original file: packages/primeng/src/scroller/scroller.ts
...
import { SpinnerIcon } from '../icons/public_api';
...
} from '../types/scroller/public_api';
    ...
    template: `
        <ng-container *ngIf="!_disabled; else disabledContainer">
            <div #element [attr.id]="_id" [attr.tabindex]="tabindex" [ngStyle]="_style" [class]="cn(cx('root'), styleClass)" (scroll)="onContainerScroll($event)" [pBind]="ptm('root')">
                <ng-container *ngIf="contentTemplate || _contentTemplate; else buildInContent">
                    <ng-container *ngTemplateOutlet="contentTemplate || _contentTemplate; context: { $implicit: loadedItems, options: $any(getContentOptions()) }"></ng-container>
                </ng-container>
        ...
        <ng-template #disabledContainer>
            ...
            <ng-container *ngIf="contentTemplate || _contentTemplate">
                <ng-container *ngTemplateOutlet="contentTemplate || _contentTemplate; context: { $implicit: items, options: { rows: $any(_items), columns: $any(loadedColumns) } }"></ng-container>
            </ng-container>
        </ng-template>
    `,
