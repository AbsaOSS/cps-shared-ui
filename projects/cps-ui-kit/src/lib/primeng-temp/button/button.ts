 ...
 * Original file: packages/primeng/src/button/button.ts
...
import type { ButtonIconTemplateContext, ButtonLoadingIconTemplateContext, ButtonPassThrough, ButtonProps, ButtonSeverity } from '../types/button/public_api';
