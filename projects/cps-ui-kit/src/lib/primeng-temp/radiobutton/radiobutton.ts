 ...
 * Original file: packages/primeng/src/radiobutton/radiobutton.ts
...
import { RadioButtonPassThrough } from '../types/radiobutton/public_api';
import type { RadioButtonClickEvent } from '../types/radiobutton/public_api';
