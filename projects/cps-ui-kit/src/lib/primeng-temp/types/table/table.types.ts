 ...
 * Original file: packages/primeng/src/types/table/table.types.ts
...
import type { FilterMetadata, LazyLoadMeta, PassThrough, PassThroughOption } from '../../api/public_api';
import type { ButtonPassThrough, ButtonProps } from '../button/public_api';
import type { CheckboxPassThrough } from '../checkbox/public_api';
import type { PaginatorPassThrough } from '../paginator/public_api';
import type { VirtualScrollerPassThrough } from '../scroller/public_api';
