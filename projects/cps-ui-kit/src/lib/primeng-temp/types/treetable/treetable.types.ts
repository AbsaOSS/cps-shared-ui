 ...
 * Original file: packages/primeng/src/types/treetable/treetable.types.ts
...
import type { FilterMetadata, LazyLoadMeta, PassThrough, PassThroughOption, SortMeta, TreeNode, TreeTableNode } from '../../api/public_api';
