 ...
 * Original file: packages/primeng/src/types/fileupload/fileupload.types.ts
...
import type { MessagePassThrough } from '../message/public_api';
import type { ProgressBarPassThrough } from '../progressbar/public_api';
