 ...
 * Original file: packages/primeng/src/types/multiselect/multiselect.types.ts
...
import type { PassThrough, PassThroughOption, ScrollerOptions } from '../../api/public_api';
import type { CheckboxPassThrough } from '../checkbox/public_api';
import type { ChipPassThrough } from '../chip/public_api';
import type { IconFieldPassThrough } from '../iconfield/public_api';
import type { InputIconPassThrough } from '../inputicon/public_api';
