 ...
 * Original file: packages/primeng/src/types/treeselect/treeselect.types.ts
...
import type { PassThrough, PassThroughOption, TreeNode } from '../../api/public_api';
import { ChipPassThrough } from '../chip/public_api';
import { OverlayPassThrough } from '../overlay/public_api';
import { TreePassThrough } from '../tree/public_api';
