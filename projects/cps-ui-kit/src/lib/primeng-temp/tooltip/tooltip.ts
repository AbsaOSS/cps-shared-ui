 ...
 * Original file: packages/primeng/src/tooltip/tooltip.ts
...
import { appendChild, createElement, fadeIn, findSingle, getOuterHeight, getOuterWidth, getViewport, getWindowScrollLeft, getWindowScrollTop, hasClass, removeChild, uuid } from '../../primeuix-temp/utils/src/index';
import { TooltipOptions } from '../api/public_api';
import { BaseComponent, PARENT_INSTANCE } from '../basecomponent/public_api';
import { BindModule } from '../bind/public_api';
import { ConnectedOverlayScrollHandler } from '../dom/public_api';
import { Nullable } from '../ts-helpers/public_api';
import { TooltipPassThroughOptions } from '../types/tooltip/public_api';
import { ZIndexUtils } from '../utils/public_api';
import { TooltipStyle } from './style/tooltipstyle';
import type { TooltipPassThrough } from '../types/tooltip/public_api';
